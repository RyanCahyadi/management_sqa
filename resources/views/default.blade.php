...
<div class="container w-full md:w-4/5 xl:w-3/5  mx-auto px-2">
    ...
    <div id='recipients' class="mt-6 lg:mt-0 rounded shadow bg-white">
        <table id="example">
            ...
            <tr>
                <td>Tiger Nixon</td>
                <td>System Architect Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio asperiores hic odio earum perferendis molestiae expedita error laborum nesciunt reprehenderit aspernatur minima atque quibusdam tenetur aliquid cupiditate veniam, fugit ratione?</td>
                <td>Edinburgh</td>
                <td>61</td>
                <td>2011/04/25</td>
                <td>$320,800</td>
